<template>
  <div class="bg-white demo-container">
    ...
    <div class="bg-primary">
      <div class="max-1200 banner" :class="computedClass">
        <div>
          <h3 class="text-light text-h4">New! Fledge Design System Generator</h3>
    ...
    <!-- Hero -->
    <section class="bg-secondary hero-bg">
      <div class="max-1200 hero" :class="computedClass">
        <div>
          <h1 class="text-h1 text-light">Start building your design system</h1>
          ...
          <svg id="demo-svg" width="100%" height="100%" viewBox="0 0 356 200" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <g id="Page-1">
              <g id="Group-2">
                ...
                <g transform="matrix(.2,0,0,.2,-90,50)">
                  <path class="text-primary" fill="currentColor" d="M1618.68,476.572C1619.73,477.658 1620.77,478.655 1621.77,479.565C1627.91,485.119 1614.9,509.962 1611.03,510.552L1635.79,571.346L1631.61,580.384C1631.61,580.384 1604.14,532.715 1596.91,528.734C1580.31,519.604 1475.26,465.892 1464.4,369.355C1453.54,272.817 1570.5,229.896 1565.43,250.922C1546.84,328.048 1572.39,405.34 1598.63,449.36C1605.07,472.07 1601.02,494.423 1601.02,494.423C1605.59,488.883 1606.62,470.189 1604.66,458.885C1606.84,462.115 1608.99,465.096 1611.11,467.809C1614.86,487.656 1606.93,503.871 1606.93,503.871C1614.2,498.114 1619.88,485.201 1618.68,476.572Z"/>
                  <path class="text-primary" fill="currentColor" d="M1684.9,44.857C1712.97,43.308 1735.88,49.297 1754,58.544C1723.1,67.246 1713.16,99.744 1710.81,109.692C1710.51,110.706 1710.3,111.679 1710.19,112.601C1710.19,112.601 1710.37,111.532 1710.81,109.692C1715.37,93.998 1741.41,67.999 1764.32,64.468C1787.53,79.323 1801.01,99.094 1805.78,111.187C1775.31,143.867 1759.83,190.64 1687.58,195.333C1479.23,208.864 1461.35,299.807 1447.25,339.3C1437.23,312.332 1432.03,287.475 1430.93,264.617C1451.95,156.044 1593.43,114.78 1695.57,112.601C1591.72,112.942 1470.34,143.988 1431.25,241.154C1439.53,135.405 1540.98,76.659 1651.53,49.904C1655.36,48.975 1659.12,48.179 1662.8,47.52C1649.17,61.726 1642.14,96.215 1649.33,105.36C1649.56,93.796 1652.64,53.45 1684.9,44.857Z"/>
                  <path class="text-primary" fill="currentColor" d="M1635.5,285.084C1637.96,285.657 1640.26,286.39 1642.31,287.219C1664.91,296.365 1677.77,264.745 1677.77,264.745C1680.38,263.605 1683.44,276.325 1680.11,284.797C1675.83,295.678 1666.47,308.493 1653.52,310.553C1625.19,315.055 1629.37,337.096 1614.96,340.799C1609.57,341.176 1615.56,350.763 1615.56,350.763L1610.34,353.258C1603.37,346.392 1591.86,329.72 1594.47,308.921C1596.65,291.559 1608.1,285.016 1620.17,283.912C1608.1,291.115 1604.05,306.491 1604.05,306.491C1604.05,306.491 1616.98,283.6 1635.5,285.084Z"/>
                </g>
                <rect class="text-primary" id="nav-bg" fill="currentColor" x="0" y="0" width="357" height="20"></rect>
                <rect class="text-white" id="nav-link-1" fill="currentColor" x="27" y="7" width="52" height="6" rx="3"></rect>
                <rect class="text-white" id="nav-link-2" fill="currentColor" x="180" y="7" width="32" height="6" rx="3"></rect>
                <rect class="text-white" id="nav-link-3" fill="currentColor" x="219" y="7" width="32" height="6" rx="3"></rect>
                <rect class="text-white" id="nav-link-4" fill="currentColor" x="258" y="7" width="32" height="6" rx="3"></rect>
                <rect class="text-white" id="nav-link-5" fill="currentColor" x="297" y="7" width="32" height="6" rx="3"></rect>
                <g id="text" transform="translate(27.000000, 65.000000)">
                  <rect class="text-black" id="text-hero" fill="currentColor" x="0" y="0" width="88" height="12" rx="6"></rect>
                  <rect class="text-dark" id="text-1" fill="currentColor" x="0" y="22" width="104" height="6" rx="3"></rect>
                  <rect class="text-dark" id="text-2" fill="currentColor" x="0" y="33" width="104" height="6" rx="3"></rect>
                  <rect class="text-dark" id="text-3" fill="currentColor" x="0" y="44" width="67" height="6" rx="3"></rect>
                  <rect class="text-primary" id="button" fill="currentColor" x="0" y="60" width="52" height="10" rx="5"></rect>
                </g>
              </g>
            </g>
          </svg>
    ...
    <!-- 3 Column Cards -->
    <section class="bg-white card-section">
...
@media screen and (max-width: calc(1200px - 2rem)) {
  .max-1200 {
    margin: 0 1rem;
  }
}
